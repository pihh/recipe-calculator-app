(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["pages-recipe-recipe-module"], {
    ...
    /***/
    function node_modulesRawLoaderDistCjsJsSrcAppPagesRecipeRecipePageHtml(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesRecipeRecipeRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecipePageRoutingModule", function () {
      ...
      var _recipe_page__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./recipe.page */
      ...
      var RecipePageRoutingModule = function RecipePageRoutingModule() {
        _classCallCheck(this, RecipePageRoutingModule);
      };

      RecipePageRoutingModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
    ...
    /***/
    function srcAppPagesRecipeRecipeModuleTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecipePageModule", function () {
      ...
      var _recipe_routing_module__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ./recipe-routing.module */
      "./src/app/pages/recipe/recipe-routing.module.ts");
      /* harmony import */


      var _recipe_page__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ./recipe.page */
      "./src/app/pages/recipe/recipe.page.ts");
      /* harmony import */
      ...
      var RecipePageModule = function RecipePageModule() {
        _classCallCheck(this, RecipePageModule);
      };

      RecipePageModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_3__["FormsModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"], _recipe_routing_module__WEBPACK_IMPORTED_MODULE_5__["RecipePageRoutingModule"], _components_components_module__WEBPACK_IMPORTED_MODULE_7__["ComponentsModule"], _directives_directives_module__WEBPACK_IMPORTED_MODULE_8__["DirectivesModule"]],
    ...
    /***/
    function srcAppPagesRecipeRecipePageScss(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppPagesRecipeRecipePageTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RecipePage", function () {
        return RecipePage;
      });
      /* harmony import */
      ...
      var _models_recipes_model__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./../../models/recipes.model */
      "./src/app/models/recipes.model.ts");
      /* harmony import */


      var _models_ingredients_model__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      ...
      var src_app_utils_parallax_header__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! src/app/utils/parallax-header */
      "./src/app/utils/parallax-header.ts");
      /* harmony import */


      var _services_data_v2_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      /*! ./../../services/data-v2.service */
      "./src/app/services/data-v2.service.ts");
      /* harmony import */


      var _utils_data__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! ../../utils/data */
      "./src/app/utils/data.ts");

      var RecipePage = /*#__PURE__*/function () {
        function RecipePage(calculator, route, recipeModel, ingredientModel, dataService, events) {
          var _this = this;
          ...
          this.recipe = {
            ...
            ingredients: [{
              name: "ingredient 1",
              thumbnail: "/assets/images/category-1.png",
              quantity: "100"
            }, {
              name: "ingredient 2",
              thumbnail: "/assets/images/category-2.png",
              quantity: "100"
            }, {
              name: "ingredient 3",
              thumbnail: "/assets/images/category-2.png",
            ...
            steps: _utils_data__WEBPACK_IMPORTED_MODULE_9__["v1"].parseRecipeSteps(["Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat", "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam."])
          };
          ...
          this.route.queryParams.subscribe(function (params) {
            var recipe = JSON.parse(params.recipe);
            _this.recipe.id = recipe.id;
            _this.recipe.thumbnail = recipe.thumbnail;
            _this.recipe.description = recipe.description;
            _this.recipe.name = recipe.name;
            _this.recipe.steps = recipe.steps;
        ...
        _createClass(RecipePage, [{
          ...
          value: function loadRecipe() {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(this, void 0, void 0, /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
              var recipeId, _ingredients, _recipe, _iterator, _step, q;

              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      recipeId = this.recipe.id; // const _data:any = await this.dataService.getRecipes({id:this.recipe.id})
                    ...
                    case 4:
                      _recipe = _context.sent;
                      _iterator = _createForOfIteratorHelper(_recipe.quantities);
                      _context.prev = 6;
                    ...
                    case 24:
                      this.recipe = _recipe;
                      this.recipe.ingredients = _ingredients; // const data: any = await this.recipeModel.find(recipeId)
          ...
          key: "setNewMacros",
          value: function setNewMacros() {
            var ingredients = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
            var nutritionalValue = arguments.length > 1 ? arguments[1] : undefined;
          ...
          key: "originalRecipe",
          value: function originalRecipe() {
            var _this$calculator$orig = this.calculator.original(this.recipe),
                ingredients = _this$calculator$orig.ingredients,
                nutritionalValue = _this$calculator$orig.nutritionalValue;

            this.setNewMacros(ingredients, nutritionalValue);
          }
        }, {
          key: "adjustRecipe",
          value: function adjustRecipe() {
            var newRecipe = this.calculator.full(this.recipe, this.targetKcals, this.targetCarbs, this.targetProteins, this.targetFats);

            var _this$calculator$kcal = this.calculator.kcals(newRecipe, this.targetKcals),
                ingredients = _this$calculator$kcal.ingredients,
                nutritionalValue = _this$calculator$kcal.nutritionalValue;
      ...
      RecipePage.ctorParameters = function () {
        return [{
      ...
      RecipePage = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-recipe',
        template: Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! raw-loader!./recipe.page.html */
        "./node_modules/raw-loader/dist/cjs.js!./src/app/pages/recipe/recipe.page.html"))["default"],
        styles: [Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"])(__webpack_require__(
        /*! ./recipe.page.scss */
        "./src/app/pages/recipe/recipe.page.scss"))["default"]]
      })], RecipePage);
      /***/
    },
    ...
    function srcAppServicesCalculatorServiceTs(module, __webpack_exports__, __webpack_require__) {
      ...
      var _utils_calculator__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ../utils/calculator */
      ...
      var CalculatorService = /*#__PURE__*/function () {
        ...
        _createClass(CalculatorService, [{
          ...
          value: function getNutritionData() {
            var quantities = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];

            var _ingredients = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
            ...
            quantities.forEach(function (q) {
              var id = Number.isInteger(q.ingredient) ? q.ingredient : q.ingredient.id;

              var _iterator2 = _createForOfIteratorHelper(_ingredients),
                  _step2;
              ...
              try {
                for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
                  ...
                  if (ingredient.id === id) {
                    ...
                    nutritionalValue.fats += (ingredient.fats || ingredient.fat || 0) / 100 * q.quantity;
                  }
                }
              } catch (err) {
                _iterator2.e(err);
            ...
            Object.keys(nutritionalValue).forEach(function (key) {
          ...
          key: "original",
          value: function original(recipe) {
            return this.extractRecipe(recipe);
          }
        }, {
          key: "kcals",
          value: function kcals(recipe) {
            var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 400;

            var _this$extractRecipe = this.extractRecipe(recipe),
                ingredients = _this$extractRecipe.ingredients,
                nutritionalValue = _this$extractRecipe.nutritionalValue;

            var ratio = target / nutritionalValue.kcals;
            recipe.quantities = recipe.quantities.map(function (el) {
          ...
          key: "full",
          value: function full(recipe) {
            var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 400;
            var carbs = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : 50;
            var proteins = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 30;
            var fats = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 20;
            var TARGET = {
              C: target * carbs / 100 / 4,
              P: target * proteins / 100 / 4,
              F: target * fats / 100 / 9
            };
            var updatedRecipe = Object(_utils_calculator__WEBPACK_IMPORTED_MODULE_2__["calculator"])(recipe, TARGET);
            updatedRecipe.quantities = updatedRecipe._quantities; // Should add some kind of validation

            return updatedRecipe;
          }
        }, {
          key: "macros",
          value: function macros(kcals, carbs, proteins, fats) {}
        }]);
    ...
    /***/
    function srcAppUtilsCalculatorTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _calculator_constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./calculator/constants */
      "./src/app/utils/calculator/constants.ts");
      /* harmony import */


      var _calculator_organize_recipe__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! ./calculator/organize-recipe */
      "./src/app/utils/calculator/organize-recipe.ts");
      /* harmony import */


      var _calculator_calculate_current_macros__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./calculator/calculate-current-macros */
      "./src/app/utils/calculator/calculate-current-macros.ts");
      /* harmony import */


      var _calculator_calculate_distances__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      /*! ./calculator/calculate-distances */
      "./src/app/utils/calculator/calculate-distances.ts");
      /* harmony import */


      var _calculator_update_recipe_macros__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(
      /*! ./calculator/update-recipe-macros */
      "./src/app/utils/calculator/update-recipe-macros.ts");

      var calculator = function calculator() {
        var recipe = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : _calculator_constants__WEBPACK_IMPORTED_MODULE_0__["RECIPE"];
        var target = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _calculator_constants__WEBPACK_IMPORTED_MODULE_0__["TARGET"];
        ...
        if (i > _calculator_constants__WEBPACK_IMPORTED_MODULE_0__["MAX"]) return recipe;
        var macros = Object(_calculator_calculate_current_macros__WEBPACK_IMPORTED_MODULE_2__["calculateCurrentMacros"])(recipe);
        var dists = Object(_calculator_calculate_distances__WEBPACK_IMPORTED_MODULE_3__["calculateDistances"])(target, macros);
    ...
    /***/
    function srcAppUtilsCalculatorCalculateCurrentMacrosTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "calculateCurrentMacros", function () {
        return calculateCurrentMacros;
      });

      var calculateCurrentMacros = function calculateCurrentMacros(recipe) {
        var macros = {
          C: 0,
          P: 0,
          F: 0
        ...
        recipe._quantities.forEach(function (ingredient) {
          macros.C += ingredient.ingredient.carbs * ingredient.quantity / 100;
          macros.P += ingredient.ingredient.proteins * ingredient.quantity / 100;
          macros.F += ingredient.ingredient.fats * ingredient.quantity / 100;
        });
    ...
    /***/
    function srcAppUtilsCalculatorCalculateDistancesTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "calculateDistances", function () {
        return calculateDistances;
      });
      /* harmony import */


      var _distance__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./distance */
      "./src/app/utils/calculator/distance.ts");

      var calculateDistances = function calculateDistances(target, macros) {
        // Where 1 = 100%
        var dists = {
          C: 1,
          P: 1,
    ...
    /***/
    function srcAppUtilsCalculatorConstantsTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function srcAppUtilsCalculatorDefineRecipeIngredientsCategoryTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "defineRecipeIngredientsCategory", function () {
        return defineRecipeIngredientsCategory;
      });

      var defineRecipeIngredientsCategory = function defineRecipeIngredientsCategory(recipe) {
        recipe._quantities.map(function (quantity) {
          var ingredient = quantity.ingredient;
          var C = ingredient.carbs * 4;
          var P = ingredient.proteins * 4;
          var F = ingredient.fats * 9;
    ...
    /***/
    function srcAppUtilsCalculatorDistanceTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var distance = function distance(macro, target, macros) {
        var t = target[macro];
        var m = macros[macro];
        return t / m;
      };
    ...
    /***/
    function srcAppUtilsCalculatorOrganizeRecipeTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "organizeRecipe", function () {
        return organizeRecipe;
      });
      /* harmony import */


      var _define_recipe_ingredients_category__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
      /*! ./define-recipe-ingredients-category */
      "./src/app/utils/calculator/define-recipe-ingredients-category.ts"); // import { definePercentageOfMacro } from './define-percentage-of-macro';


      var organizeRecipe = function organizeRecipe(recipe) {
        var shouldDefineCategories = true;
        var shouldMapPercentageOfType = false;
        ...
        recipe._quantities = recipe._quantities.map(function (el) {
          var id = el.ingredient;
          var type = el.type;

          var _iterator3 = _createForOfIteratorHelper(ingredients),
              _step3;
        ...
        if (shouldDefineCategories) recipe = Object(_define_recipe_ingredients_category__WEBPACK_IMPORTED_MODULE_0__["defineRecipeIngredientsCategory"])(recipe); // if (shouldMapPercentageOfType) recipe = definePercentageOfMacro(recipe);
    ...
    /***/
    function srcAppUtilsCalculatorUpdateRecipeMacrosTs(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "updateRecipeMacros", function () {
        return updateRecipeMacros;
      });

      var updateRecipeMacros = function updateRecipeMacros(recipe, dists) {
        recipe._quantities.map(function (el) {
          var type = el.type;
          el.quantity = el.quantity * dists[type];
          return el;
        });
...
//# sourceMappingURL=pages-recipe-recipe-module-es5.js.map